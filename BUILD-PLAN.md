...
| **Wk 4** | Triage gates · query budget caps · **registry poller begins**<br><br>*Gate:* ~10–15% survival to extraction *within the sources swept*, tracked from day one<br>`FR-7` `FR-8` `FR-11` `NFR-3` | **Quote verification** against a hand-made `thread_context` · model page · capability page<br><br>*Gate:* a fabricated quote never persists<br>`FR-12` `FR-13` `FR-23` `FR-24` |
