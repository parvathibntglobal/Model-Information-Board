# DeepSeek V4 Pro - arXiv Scrape Results

**Run (UTC):** 2026-08-31T11:02:15.574872+00:00  
**Source:** arXiv API - `http://export.arxiv.org/api/query` (live query, no cache)  
**Scope:** 30 active subjects from `arxiv_subjects` (`is_active = 1`)  
**Keyword variants:** `Deepseek V4 pro`, `deepseek-v4-pro`, `deepseekv4pro`, `deepseek-v4-pro-0813`  
**Confirmed articles:** **43**

---

## 1. Summary

**43 arXiv papers** reference DeepSeek V4 Pro, spanning **2026-01-06 -> 2026-08-26**.

Key characteristics of the result set:

- **The phrase appears in 0 of 43 titles - every mention is in the abstract.** No paper *introduces* DeepSeek V4 Pro; it appears as a model being evaluated, benchmarked, or used as a baseline/judge. There is no DeepSeek V4 Pro tech report on arXiv.
- **Volume is accelerating:** 2026-01 = 2, 2026-04 = 2, 2026-05 = 5, 2026-06 = 10, 2026-07 = 8, 2026-08 = 16 - roughly a third of all mentions land in the most recent month.
- **No dated snapshot exists.** The variant `deepseek-v4-pro-0813` returned **0 results**, and a regex sweep for any `deepseek-v4-pro-<digits>` form across all 478 fetched records found **none**. That variant can be retired from the keyword list.
- **The subject filter costs nothing.** Each variant was run twice - restricted to the 30 active subjects and unrestricted across all of arXiv - and both returned identical counts, so every DeepSeek V4 Pro paper on arXiv already falls inside the tracked subjects.

### Per-variant results

| Keyword variant | Within active subjects | All of arXiv (control) | Literal-phrase matches |
|---|---|---|---|
| `Deepseek V4 pro` | 44 | 44 | 43 |
| `deepseek-v4-pro` | 44 | 44 | 43 |
| `deepseekv4pro` | 1 | 1 | 0 |
| `deepseek-v4-pro-0813` | 0 | 0 | 0 |

Notes on the raw counts:

- `Deepseek V4 pro` and `deepseek-v4-pro` return the **same 44 records** - the arXiv API tokenizes the phrase and the hyphens, so both queries reduce to the same token search. 43 of those 44 were confirmed to contain the literal phrase; the discarded record is `2602.02934` (*AgenticSZZ*), which matches the tokens `deepseek` + `v4` + `pro` separately without the phrase.
- `deepseekv4pro` (unseparated) returns 1 record, `2507.19219`, which does **not** contain the phrase - arXiv fell back to a loose match. Discarded.
- Every count reported here is a complete result set, not a page-limit truncation.
...
### Surface forms found in the corpus

The name is written inconsistently across papers - worth noting for future keyword matching:

| Written form | Occurrences |
|---|---|
| `DeepSeek-V4-Pro` | 23 |
| `DeepSeek V4 Pro` | 15 |
| `DeepSeek V4-Pro` | 4 |
...
Newest first. Each entry quotes the sentence fragment containing the mention.

### 1. XREPOTEST: Benchmarking Multilingual Repository-Level Unit Test Generation for Large Language Models

- **arXiv ID:** `2608.25939`
- **Published:** 2026-08-26  |  **Updated:** 2026-08-26
- **Categories:** cs.SE  (primary: `cs.SE`)
- **Authors:** Dung Le Quang, Dong Cao Van, Nam Le Hai, Linh Ngo Van, Anh M. T. Bui, Phuong T. Nguyen
- **Links:** [abs](https://arxiv.org/abs/2608.25939v1) - [pdf](https://arxiv.org/pdf/2608.25939v1)
- **Form used:** `DeepSeek V4-Pro`
- **Mention:**

  > ... tionality. Experiments with 14 state-of-the-art LLMs, including Claude 4.5, GPT-5.2, DeepSeek V4-Pro, and Qwen families, reveal a substantial gap between standalone and repository-level ...
...
### 2. EVOMAL: Self-Poisoning in Self-Evolving Coding Agents

- **arXiv ID:** `2608.25776`
- **Published:** 2026-08-26  |  **Updated:** 2026-08-26
- **Categories:** cs.CR, cs.AI  (primary: `cs.CR`)
- **Authors:** Xiaodong Wu, Yu Shi, Qi Li, Zhimin Zhao, Xiangman Li, Bram Adams, ... (+2 more)
- **Links:** [abs](https://arxiv.org/abs/2608.25776v1) - [pdf](https://arxiv.org/pdf/2608.25776v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... y malicious skills as were planted. The vulnerability also appears without a banner: DeepSeek-V4-Pro reaches 11.1% ASPR with the payload alone. Tailoring the planted skill descriptions ...
...
### 3. CONTRAMEM: Learning Self-Evolving Procedural Memory from Contrasting Multi-Model Trajectories

- **arXiv ID:** `2608.22533`
- **Published:** 2026-08-23  |  **Updated:** 2026-08-23
- **Categories:** cs.AI  (primary: `cs.AI`)
- **Authors:** Zheyuan Deng, Binghang Lu, Hanqi Feng, Shirley Huang, Dianzhuo Wang, Yuanda Xu, ... (+7 more)
- **Links:** [abs](https://arxiv.org/abs/2608.22533v1) - [pdf](https://arxiv.org/pdf/2608.22533v1)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... consistent per-model gains (GPT-5.5: 27.5 to 61.0; Claude Sonnet 4.6: 28.0 to 52.5; DeepSeek V4 Pro: 23.0 to 52.5). The same bank transfers unchanged to the unseen Qwen3.7 Plus (18.5 t ...
...
### 4. ReguSim: Evaluating LLM Agent Rule Grounding in Financial Compliance

- **arXiv ID:** `2608.19974`
- **Published:** 2026-08-20  |  **Updated:** 2026-08-20
- **Categories:** cs.AI  (primary: `cs.AI`)
- **Authors:** Yiyang Luo, Yihang Jiang, Qijun Xie, Liang Lan, Lin Willian Cong, Anyi Rao, ... (+1 more)
- **Links:** [abs](https://arxiv.org/abs/2608.19974v1) - [pdf](https://arxiv.org/pdf/2608.19974v1)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... , attempted action, execution enforcement, and monitor evidence. In trader runs with DeepSeek V4 Pro and Gemini 3.5 Flash, visible rules reduce but do not eliminate rejected actions, an ...
...
### 5. Rethinking Automated Program Repair: The Impact of Bug Complexity, Fault Localization, and LLM Cost-efficiency
...
- **Links:** [abs](https://arxiv.org/abs/2608.14065v2) - [pdf](https://arxiv.org/pdf/2608.14065v2)
- **Form used:** `DeepSeek-V4-pro`
- **Mention:**

  > ... ult localization becomes less precise. GPT-5 repairs 7 and 39 more complex bugs than DeepSeek-V4-pro and DeepSeek-V3.2, respectively; whereas the total repair cost of DeepSeek-V3.2 show ...
...
### 6. Why Do Prefetchers Fail? Let Agents Answer

- **arXiv ID:** `2608.13027`
- **Published:** 2026-08-13  |  **Updated:** 2026-08-25
- **Categories:** cs.AR  (primary: `cs.AR`)
- **Authors:** Xiangfeng Sun, Ceyu Xu, Ningzhi Ai, Zeyu Zhu, Yiyang Yuan, Yuan Xie
- **Links:** [abs](https://arxiv.org/abs/2608.13027v2) - [pdf](https://arxiv.org/pdf/2608.13027v2)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... ulator-in-the-loop discovery beyond model priors. The campaign consumes 1.91 billion DeepSeek V4 Pro tokens. On SPEC CPU2006 and SPEC CPU2017, MoP achieves a 61.1% geomean IPC speedup o ...
...
- **Categories:** cs.CR, cs.AI  (primary: `cs.CR`)
- **Authors:** Junliang Liu, Ruoyu Li, Wenxin Tang, Jingyu Xiao, Zhenyu Liu, Jingheng Xu, ... (+1 more)
- **Links:** [abs](https://arxiv.org/abs/2608.12273v1) - [pdf](https://arxiv.org/pdf/2608.12273v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... LLM backends and 491 held-out tasks under single-task and multi-turn conditions. On DeepSeek-V4-Pro, the matched coordinator is selected in 80.02% of tasks; among coordinator-hit runs ...
...
- **arXiv ID:** `2608.12138`
- **Published:** 2026-08-12  |  **Updated:** 2026-08-12
- **Categories:** cs.CL, cs.AI, cs.HC, cs.IR, cs.LG  (primary: `cs.CL`)
- **Authors:** Praveen Reddy, Charuta Mandke, Suvrankar Datta, Sarah Khan, Siddharth Reddy Anthireddy, Shitij Arora, ... (+1 more)
- **Links:** [abs](https://arxiv.org/abs/2608.12138v1) - [pdf](https://arxiv.org/pdf/2608.12138v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... laude Opus 4.8, Gemini 3.5 Pro, Grok 4.3) and graded by a neutral open-weight judge (DeepSeek-V4-Pro) sharing no lineage with any system tested. Here the gap narrowed to parity: VITA an ...
...
### 9. Not a Monolith: Lab-Level Divergence in the Cooperative Equilibria of Chinese Frontier LLM Agents

- **arXiv ID:** `2608.10262`
- **Published:** 2026-08-10  |  **Updated:** 2026-08-10
- **Categories:** cs.MA  (primary: `cs.MA`)
- **Authors:** Francisco León Zúñiga Bolívar
- **Links:** [abs](https://arxiv.org/abs/2608.10262v1) - [pdf](https://arxiv.org/pdf/2608.10262v1)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... ingle bloc or as distinct laboratories? We study four frontier-tier Chinese models - DeepSeek V4 Pro, Qwen3-Max, Kimi K2.5 and GLM-5.1 - in an evolutionary Iterated Prisoner's Dilemma, ...
...
- **Categories:** cs.DC  (primary: `cs.DC`)
- **Authors:** Issac Zhu, Hscos Zhang, Keith Jiang, Jack Li, Hugh Yin, Jason Zhao
- **Links:** [abs](https://arxiv.org/abs/2608.08482v1) - [pdf](https://arxiv.org/pdf/2608.08482v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... via a remote-mapping mechanism that removes NCCL setup. In experiments on NVL72 with DeepSeek-V4-Pro and DeepSeek-V4-Flash, FlashClone maps remote weight memory in ~10 ms (versus 10-110 ...
...
### 11. Who Verifies the Benchmark? Decentralizing Trust in Large Language Model Evaluation

- **arXiv ID:** `2608.07762`
- **Published:** 2026-08-07  |  **Updated:** 2026-08-07
- **Categories:** cs.AI, cs.CR  (primary: `cs.AI`)
- **Authors:** Sahil Pardasani, Madhusudan Singh
- **Links:** [abs](https://arxiv.org/abs/2608.07762v1) - [pdf](https://arxiv.org/pdf/2608.07762v1)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... roblem using seven verifier models: GPT-OSS 120B, Llama 3.3 70B, GLM 5.1, Qwen3 32B, DeepSeek V4 Pro, Mistral Large3, and Sarvam M. They score anonymous and identity-disclosed responses ...
...
- **Links:** [abs](https://arxiv.org/abs/2608.07437v1) - [pdf](https://arxiv.org/pdf/2608.07437v1)
- **Form used:** `DeepSeek-V4-Pro`, `DeepSeekV4-Pro`
- **Mention:**

  > ... and outperforms strong proprietary and open-source baselines, including GPT-5.4 and DeepSeekV4-Pro, achieving a 21% average relative improvement in single-trial success over DeepSeek- ...
...
### 13. IB-RL: Isolated Bilateral Reinforcement Learning for Strategic Dialogue Agents

- **arXiv ID:** `2608.06735`
- **Published:** 2026-08-07  |  **Updated:** 2026-08-07
- **Categories:** cs.AI, cs.CL  (primary: `cs.AI`)
- **Authors:** Senhao Wang, Chenghao Cai, Haitao Hu, Mingxing Huang, Xingguang Wang, Wenhao Li, ... (+1 more)
- **Links:** [abs](https://arxiv.org/abs/2608.06735v1) - [pdf](https://arxiv.org/pdf/2608.06735v1)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... e best unilateral RL baseline. On Deal-or-NoDeal, it reaches 98.4% agreement against DeepSeek V4 Pro, compared to 86.4% for the best unilateral baseline. These results indicate that joi ...
...
### 14. Recursive Synthesis for Long-Horizon Terminal Tasks

- **arXiv ID:** `2608.05466`
- **Published:** 2026-08-05  |  **Updated:** 2026-08-12
- **Categories:** cs.AI, cs.LG  (primary: `cs.AI`)
- **Authors:** Zhongzhi Li, Yucheng Shi, Zongxia Li, Ruhan Wang, Anhao Li, Zixun Huang, ... (+5 more)
- **Links:** [abs](https://arxiv.org/abs/2608.05466v3) - [pdf](https://arxiv.org/pdf/2608.05466v3)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... om 67 to 374 lines, the median number of executed commands grows from 40 to 244, and DeepSeek-V4-Pro pass@4 drops from 90% at R1 to 2.5% at R15. To demonstrate training utility, we coll ...
...
### 15. When Agentic Executions Fail: Detecting and Localizing Runtime Faults from Telemetry

- **arXiv ID:** `2608.14680`
- **Published:** 2026-08-04  |  **Updated:** 2026-08-04
- **Categories:** cs.AI, cs.SE  (primary: `cs.AI`)
- **Authors:** Chenkai Zhang, Yiran Li, Yifang Tian, Michalis Bachras, Hans-Arno Jacobsen
- **Links:** [abs](https://arxiv.org/abs/2608.14680v1) - [pdf](https://arxiv.org/pdf/2608.14680v1)
- **Form used:** `DeepSeek-v4-pro`
- **Mention:**

  > ... p to 14B parameters reach only 13.6-19.2% top-1 fault-type accuracy and the frontier DeepSeek-v4-pro only 24.8%, while jointly identifying the fault type and its location tops out at 22 ...
...
### 16. Claim Plane: Reliability Gains and the Limits of Selective Concurrency for Parallel Coding Agents: A 30-Pair, Three-Seed Confirmatory Study of Deterministic Pre-Write Admission

- **arXiv ID:** `2608.00947`
- **Published:** 2026-08-02  |  **Updated:** 2026-08-02
- **Categories:** cs.SE  (primary: `cs.SE`)
- **Authors:** Maxim Nikolaev
- **Links:** [abs](https://arxiv.org/abs/2608.00947v1) - [pdf](https://arxiv.org/pdf/2608.00947v1)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... abels, with three coder seeds, four coordination arms, and 360 completed executions. DeepSeek V4 Pro generated 60 feature-level planner declarations once; the declarations were frozen a ...
...
- **Links:** [abs](https://arxiv.org/abs/2607.28086v1) - [pdf](https://arxiv.org/pdf/2607.28086v1)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... we nine different models: four frontier (Claude Sonnet 4.6, Claude Opus 4.7, GPT-5, DeepSeek V4 Pro), two mid-tier (DeepSeek V4 Flash, gpt-oss-120b), and three open-weights (qwen3.6-27 ...
...
- **Links:** [abs](https://arxiv.org/abs/2607.27294v1) - [pdf](https://arxiv.org/pdf/2607.27294v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... s, OpenClaw, Claude Code, and Codex) and five LLM backends (GPT-5.5, Gemini 3.1 Pro, DeepSeek-V4-Pro, MiniMax-M3, and Qwen3.7-Plus) on these cases, yielding 6,560 runs. Overall, 4,461 r ...
...
### 19. CodeSpec: Dual Executable Specifications for Agentic Long-Horizon Feature Development

- **arXiv ID:** `2607.26777`
- **Published:** 2026-07-29  |  **Updated:** 2026-07-29
- **Categories:** cs.SE  (primary: `cs.SE`)
- **Authors:** Peiding Wang, Li Zhang, Fang Liu, Taichuan Li, Yinghao Zhu
- **Links:** [abs](https://arxiv.org/abs/2607.26777v1) - [pdf](https://arxiv.org/pdf/2607.26777v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... in existing repositories, CodeSpec achieves 70.7%, 55.0%, and 49.9% pass rates under DeepSeek-V4-Pro, outperforming representative baselines such as Claude Code. Results on the reposito ...
...
### 20. ZenGen: Social Mind for LLMs

- **arXiv ID:** `2607.23740`
- **Published:** 2026-07-26  |  **Updated:** 2026-08-21
- **Categories:** cs.CL  (primary: `cs.CL`)
- **Authors:** ZenGen Team, Ao Xiang, Bi Jingping, Chen Jiahui, Chen Lehan, Chen Yilin, ... (+53 more)
- **Links:** [abs](https://arxiv.org/abs/2607.23740v2) - [pdf](https://arxiv.org/pdf/2607.23740v2)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... e2 achieving the best average score and ZenGen-32B-Stage2 remaining competitive with DeepSeek-V4-Pro. For deployment-time grounding, we build Actio, a harness-controlled inference archi ...
...
### 21. Benchmarking Agents for Proving Theorems in Quantum Algorithms and Quantum Information

- **arXiv ID:** `2607.21533`
- **Published:** 2026-07-23  |  **Updated:** 2026-07-23
- **Categories:** quant-ph  (primary: `quant-ph`)
- **Authors:** Lei Zhang, Yusheng Zhao, Yimeng Cao, Ranyiliu Chen, Mingrui Jing, Jizhe Lai, ... (+7 more)
- **Links:** [abs](https://arxiv.org/abs/2607.21533v1) - [pdf](https://arxiv.org/pdf/2607.21533v1)
- **Form used:** `DeepSeek V4-Pro`
- **Mention:**

  > ... y weights assigned before model execution. We evaluate four models-GPT-5.5, Kimi K3, DeepSeek V4-Pro, and MiniMax M3-within a common theorem-proving framework under two settings: a task ...
...
### 22. Solar Open 2 Technical Report

- **arXiv ID:** `2607.20062`
- **Published:** 2026-07-22  |  **Updated:** 2026-07-24
- **Categories:** cs.CL  (primary: `cs.CL`)
- **Authors:** Sungrae Park, Sanghoon Kim, Gyoungjin Gim, Jungho Cho, Hyunwoong Ko, Minbyul Jeong, ... (+47 more)
- **Links:** [abs](https://arxiv.org/abs/2607.20062v2) - [pdf](https://arxiv.org/pdf/2607.20062v2)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**
...
### 23. DARWIN: Evolving Jailbreak Adversary and Guardrail for LLM Safety Evaluation and Protection

- **arXiv ID:** `2607.19829`
- **Published:** 2026-07-22  |  **Updated:** 2026-07-22
- **Categories:** cs.CR  (primary: `cs.CR`)
- **Authors:** Weiwei Qi, Zefeng Wu, Zhilin Guo, Tianhang Zheng, Chaochao Lu, Liang He, ... (+2 more)
- **Links:** [abs](https://arxiv.org/abs/2607.19829v1) - [pdf](https://arxiv.org/pdf/2607.19829v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... rdrails, it achieves state-of-the-art attack success rates, including nearly 100% on DeepSeek-V4-Pro and YuFeng-XGuard and over 90% on GPT-5.5. On the defense side, we introduce DARWIN- ...
...
### 24. STOCKTAKE: Measuring the Gap Between Perception and Action in LLM Agents with a Fair Oracle

- **arXiv ID:** `2607.13618`
- **Published:** 2026-07-15  |  **Updated:** 2026-07-15
- **Categories:** cs.AI, cs.LG  (primary: `cs.AI`)
- **Authors:** Sagar Deb, Ashwanth Krishnan
- **Links:** [abs](https://arxiv.org/abs/2607.13618v1) - [pdf](https://arxiv.org/pdf/2607.13618v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... d separately. On fifty seeds with curated stress profiles, Claude Sonnet 5, GPT-5.4, DeepSeek-V4-Pro, and Grok 4.5 detect 84-88% of hidden failures, typically within a week of onset, ye ...
...
### 25. Calibrating the Evaluator: Does Probability Calibration Mitigate Preference Coupling in LLM Agent Feedback Loops?

- **arXiv ID:** `2606.31371`
- **Published:** 2026-06-30  |  **Updated:** 2026-06-30
- **Categories:** cs.LG, cs.AI, cs.CL  (primary: `cs.LG`)
- **Authors:** Zewen Liu
- **Links:** [abs](https://arxiv.org/abs/2606.31371v1) - [pdf](https://arxiv.org/pdf/2606.31371v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... TTRL (win/loss) with confidence-calibrated TTRL (probability-weighted updates) using DeepSeek-V4-Pro as executor and GLM5.2 as evaluator, we find that calibration reduces the coupling c ...
...
### 26. Scaling the Horizon, Not the Parameters: Reaching Trillion-Parameter Performance with a 35B Agent

- **arXiv ID:** `2606.30616`
- **Published:** 2026-06-29  |  **Updated:** 2026-07-13
- **Categories:** cs.CL  (primary: `cs.CL`)
- **Authors:** Lei Bai, Zongsheng Cao, Yang Chen, Zhiyao Cui, Shangheng Du, Yue Fan, ... (+47 more)
- **Links:** [abs](https://arxiv.org/abs/2606.30616v2) - [pdf](https://arxiv.org/pdf/2606.30616v2)
- **Form used:** `DeepSeek-V4-pro`
- **Mention:**

  > ... ong-horizon agent benchmarks. Compared with 1T-parameter model such as Kimi-K2.6 and DeepSeek-V4-pro, Agents-A1 achieves leading results on SEAL-0 (56.4), IFBench (80.6), HiPhO (46.4), ...
...
### 27. EMPATH: A Multilingual Auditor-Judge Benchmark for Safety Evaluation of Emotional-Support Chatbots

- **arXiv ID:** `2606.30256`
- **Published:** 2026-06-29  |  **Updated:** 2026-06-29
- **Categories:** cs.AI, cs.CY  (primary: `cs.AI`)
- **Authors:** Camilo Chacón Sartori
- **Links:** [abs](https://arxiv.org/abs/2606.30256v1) - [pdf](https://arxiv.org/pdf/2606.30256v1)
- **Form used:** `deepseek-v4-pro`
- **Mention:**

  > ... steadiest model swings from 2 to 10 on a crisis metric across identical re-runs, and deepseek-v4-pro returns a different conversation on every run even at temperature 0. Run-to-run reli ...
...
### 28. The Signal-Coverage Matrix: Stratifying Type and Semantic Errors in Statement Autoformalization

- **arXiv ID:** `2606.28013`
- **Published:** 2026-06-26  |  **Updated:** 2026-06-26
- **Categories:** cs.CL  (primary: `cs.CL`)
- **Authors:** Chengxiao Dai, Zhaokun Yan, Zhanhui Lin
- **Links:** [abs](https://arxiv.org/abs/2606.28013v1) - [pdf](https://arxiv.org/pdf/2606.28013v1)
- **Form used:** `DeepSeek V4-Pro`
- **Mention:**

  > ... nly (TO), semantic-only (SO), or both fail (BF). On ProofNet\# and MiniF2F-test with DeepSeek V4-Pro across Vanilla, Lean-Retry, Sample-Filter, and Stratified Autoformalization (SAF): ( ...
...
### 29. EvoClawBench: Can Agents Learn Reusable Skills from Their Own Runs?

- **arXiv ID:** `2607.09711`
- **Published:** 2026-06-23  |  **Updated:** 2026-06-23
- **Categories:** cs.LG, cs.SE  (primary: `cs.LG`)
- **Authors:** Zhiyuan Peng, Xin Yin, Chenhao Ying, Zhe Cui, Zixiang Ding, Zhenhua Liu, ... (+2 more)
- **Links:** [abs](https://arxiv.org/abs/2607.09711v1) - [pdf](https://arxiv.org/pdf/2607.09711v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... l modes and MiniMax-M2.7 improves from 90.97% to 94.50% under PostSkill, but nanobot DeepSeek-V4-Pro drops from 77.77% to 4.80% with PreSkill and 0.99% with PostSkill. OpenClaw shows si ...
...
### 30. Bayesian-Calibrated Detection of Hallucinated Package Imports in AI-Assisted Code

- **arXiv ID:** `2606.13918`
- **Published:** 2026-06-11  |  **Updated:** 2026-06-11
- **Categories:** cs.SE, cs.CR  (primary: `cs.SE`)
- **Authors:** Lom M. Hillah, Jean-Marc Richard, Ryan Hasnaoui
- **Links:** [abs](https://arxiv.org/abs/2606.13918v1) - [pdf](https://arxiv.org/pdf/2606.13918v1)
- **Form used:** `DeepSeek-v4-pro`
- **Mention:**

  > ... ross a six-model panel spanning four cloud models (Claude-Sonnet-4.6, Mistral-Large, DeepSeek-v4-pro, DeepSeek-R1) and two local open-weight code models (Mistral Codestral, Meta CodeLla ...
...
### 31. Moonshine: An Autonomous Mathematical Research Agent Centered on Conjecture Generation

- **arXiv ID:** `2606.10806`
- **Published:** 2026-06-09  |  **Updated:** 2026-06-09
- **Categories:** cs.AI, math.FA  (primary: `cs.AI`)
- **Authors:** Xiaoyang Chen, Xiang Jiang
- **Links:** [abs](https://arxiv.org/abs/2606.10806v1) - [pdf](https://arxiv.org/pdf/2606.10806v1)
- **Form used:** `DeepSeek-V4-pro`
- **Mention:**

  > ... on the whole space, then it must be globally injective. By invoking GPT-5.5-pro and DeepSeek-V4-pro separately, Moonshine obtained independent complete proofs for the case \(N=n+1\). I ...
...
### 32. Document-Authored Control-Signal Impersonation: A Low-Cost Indirect Prompt Attack on RAG Safety Boundaries

- **arXiv ID:** `2606.09005`
- **Published:** 2026-06-08  |  **Updated:** 2026-06-08
- **Categories:** cs.CR, cs.CL  (primary: `cs.CR`)
- **Authors:** Jianguo Zhu
- **Links:** [abs](https://arxiv.org/abs/2606.09005v1) - [pdf](https://arxiv.org/pdf/2606.09005v1)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... ts. We interpret the evidence by model regime rather than as six equal replications: DeepSeek V4 Pro and Qwen3.5-397B provide the cleanest positive lift, DeepSeek V4 Flash is a high-sus ...
...
### 33. Discourse-Role Labels as Presentation-Time Variables for Context Use in Language Models

- **arXiv ID:** `2606.04109`
- **Published:** 2026-06-02  |  **Updated:** 2026-06-08
- **Categories:** cs.CL  (primary: `cs.CL`)
- **Authors:** Jianguo Zhu, Xiangmei Li, Wenjie Liu
- **Links:** [abs](https://arxiv.org/abs/2606.04109v2) - [pdf](https://arxiv.org/pdf/2606.04109v2)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... is measured by whether the model outputs the injected wrong option. Across GPT-5.5, DeepSeek V4 Pro, Llama-3-8B-Instruct, and Qwen2.5-7B-Instruct, Misleading Adoption Rate shifts by 56 ...
...
### 34. K-BrowseComp: A Web Browsing Agent Benchmark Grounded in Korean Contexts

- **arXiv ID:** `2606.02404`
- **Published:** 2026-06-01  |  **Updated:** 2026-06-01
- **Categories:** cs.CL  (primary: `cs.CL`)
- **Authors:** Nahyun Lee, Dongkeun Yoon, Guijin Son, Geewook Kim, Dayoon Ko, Jeonghun Park, ... (+9 more)
- **Links:** [abs](https://arxiv.org/abs/2606.02404v1) - [pdf](https://arxiv.org/pdf/2606.02404v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... lidated by native Korean speakers. On this subset, frontier LLMs, including GPT-5.5, DeepSeek-V4-Pro, and GLM-5.1, reach only 30.00--45.67\%, a substantial drop from BrowseComp, while K ...
...
### 35. Hy-MT2: A Family of Fast, Efficient and Powerful Multilingual Translation Models in the Wild

- **arXiv ID:** `2605.22064`
- **Published:** 2026-05-21  |  **Updated:** 2026-05-25
- **Categories:** cs.CL  (primary: `cs.CL`)
- **Authors:** Mao Zheng, Zheng Li, Tao Chen, Bo Lv, Mingrui Sun, Mingyang Song, ... (+7 more)
- **Links:** [abs](https://arxiv.org/abs/2605.22064v2) - [pdf](https://arxiv.org/pdf/2605.22064v2)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... owing translation tasks. The 7B and 30B models outperform open-source models such as DeepSeek-V4-Pro and Kimi K2.6 in fast-thinking mode, while the lightweight 1.8B model also surpasses ...
...
### 36. AgentForesight: Online Auditing for Early Failure Prediction in Multi-Agent Systems

- **arXiv ID:** `2605.08715`
- **Published:** 2026-05-09  |  **Updated:** 2026-05-13
- **Categories:** cs.CL, cs.AI, cs.MA  (primary: `cs.CL`)
- **Authors:** Boxuan Zhang, Jianing Zhu, Zeru Shi, Dongfang Liu, Ruixiang Tang
- **Links:** [abs](https://arxiv.org/abs/2605.08715v2) - [pdf](https://arxiv.org/pdf/2605.08715v2)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... ark, AgentForesight-7B outperforms leading proprietary models, including GPT-4.1 and DeepSeek-V4-Pro, achieving up to +19.9% performance gain and 3$\times$ lower step localization error ...
...
### 37. Retrieval and Multi-Hop Reasoning in 1M-Token Context Windows: Evaluating LLMs on Classical Chinese Text

- **arXiv ID:** `2605.02173`
- **Published:** 2026-05-04  |  **Updated:** 2026-05-04
- **Categories:** cs.AI  (primary: `cs.AI`)
- **Authors:** Eric H. C. Chow
- **Links:** [abs](https://arxiv.org/abs/2605.02173v1) - [pdf](https://arxiv.org/pdf/2605.02173v1)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... , Qwen3.6-plus) collapsing sharply between 512K and 1M; and a smooth-decline regime (DeepSeek V4 Pro) decaying gradually across the entire range. The findings suggest that nominal conte ...
...
### 38. MAP-Law: Coverage-Driven Retrieval Control for Multi-Turn Legal Consultation

- **arXiv ID:** `2605.01486`
- **Published:** 2026-05-02  |  **Updated:** 2026-05-20
- **Categories:** cs.AI  (primary: `cs.AI`)
- **Authors:** Qinchuan Cheng, Jiaqi Liu, Ruixuan Xie, Xiaoya Yuan, Yuxin Liu
- **Links:** [abs](https://arxiv.org/abs/2605.01486v2) - [pdf](https://arxiv.org/pdf/2605.01486v2)
- **Form used:** `DeepSeek V4-Pro`
- **Mention:**

  > ... e synthetic Chinese labor-law consultation pilot with fixed legal-element schemas, a DeepSeek V4-Pro action-selection variant achieves full measured element coverage under the pilot met ...
...
### 39. VisInject: Disruption != Injection -- A Dual-Dimension Evaluation of Universal Adversarial Attacks on Vision-Language Models

- **arXiv ID:** `2605.01449`
- **Published:** 2026-05-02  |  **Updated:** 2026-05-02
- **Categories:** cs.CR, cs.AI  (primary: `cs.CR`)
- **Authors:** Pang Liu, Yingjie Lao
- **Links:** [abs](https://arxiv.org/abs/2605.01449v1) - [pdf](https://arxiv.org/pdf/2605.01449v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... ordinal categorical none/weak/partial/confirmed for Precise Injection. The judge is DeepSeek-V4-Pro in thinking mode, calibrated against Claude Opus 4.7 with Cohen's $κ$ = 0.77 on the ...
...
### 40. DeepSeek-V4: Towards Highly Efficient Million-Token Context Intelligence

- **arXiv ID:** `2606.19348`
- **Published:** 2026-04-26  |  **Updated:** 2026-04-26
- **Categories:** cs.CL, cs.AI  (primary: `cs.CL`)
- **Authors:** DeepSeek-AI, Anyi Xu, Bangcai Lin, Bing Xue, Bingxuan Wang, Bingzheng Xu, ... (+313 more)
- **Links:** [abs](https://arxiv.org/abs/2606.19348v1) - [pdf](https://arxiv.org/pdf/2606.19348v1)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... DeepSeek-V4 series, including two strong Mixture-of-Experts (MoE) language models -- DeepSeek-V4-Pro with 1.6T parameters (49B activated) and DeepSeek-V4-Flash with 284B parameters (13B ...
...
### 41. The Rise of Verbal Tics in Large Language Models: A Systematic Analysis Across Frontier Models

- **arXiv ID:** `2604.19139`
- **Published:** 2026-04-21  |  **Updated:** 2026-07-05
- **Categories:** cs.CL, cs.AI  (primary: `cs.CL`)
- **Authors:** Shuai Wu, Xue Li, Yanna Feng, Yufang Li, Zhijun Wang, Ran Wang
- **Links:** [abs](https://arxiv.org/abs/2604.19139v3) - [pdf](https://arxiv.org/pdf/2604.19139v3)
- **Form used:** `DeepSeek V4 Pro`
- **Mention:**

  > ... GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro, Grok 4.3, Doubao-Seed-2.1-pro, Kimi K2.6, DeepSeek V4 Pro, and GLM-5.2. Utilizing a custom evaluation framework for standardized API-based eva ...
...
### 42. Mechanistic Analysis of Catastrophic Forgetting in Large Language Models During Continual Fine-tuning

- **arXiv ID:** `2601.18699`
- **Published:** 2026-01-26  |  **Updated:** 2026-06-13
- **Categories:** cs.LG, cs.CL  (primary: `cs.LG`)
- **Authors:** Gustav Olaf Yunus Laitinen-Fredriksson Lundstrom-Imanov
- **Links:** [abs](https://arxiv.org/abs/2601.18699v2) - [pdf](https://arxiv.org/pdf/2601.18699v2)
- **Form used:** `DeepSeek-V4-Pro`
- **Mention:**

  > ... deep mechanistic interpretation of ten prominent open-weight architectures (such as DeepSeek-V4-Pro, Llama 4 Maverick, and Qwen 3.6-27B). Through weight-space trajectory tracking, Cent ...
...
### 43. AfriEconQA: A Benchmark for Quantitative and Temporal Reasoning over World Bank Economic Reports

- **arXiv ID:** `2601.15297`
- **Published:** 2026-01-06  |  **Updated:** 2026-07-29
- **Categories:** cs.CL  (primary: `cs.CL`)
- **Authors:** Edward Ajayi, Mustapha Alaba, David Stephen
- **Links:** [abs](https://arxiv.org/abs/2601.15297v3) - [pdf](https://arxiv.org/pdf/2601.15297v3)
- **Form used:** `DeepSeek v4-pro`
- **Mention:**

  > ... tratified human-validation subset for gold-label auditing. We evaluate Qwen 3.6 35B, DeepSeek v4-pro, and Gemma 4 12B IT under zero-shot, oracle, and hybrid retrieval-augmented generati ...
...
- Ran through the project's own fetcher (`app/services/arxiv_fetcher.py` - `fetch_arxiv_page`, `parse_arxiv_entry`, `get_active_categories`), so parsing and the 3-second inter-request rate limit match the production scraper.
- Subjects were read live from Turso (`arxiv_subjects WHERE is_active = 1`). **Nothing was written to the database** - no rows inserted into `papers`, no scoring, enrichment, or editor runs triggered.
- Sort order `submittedDate desc`, pagination 100/page until exhausted.
- Because the arXiv API tokenizes quoted phrases, every returned record was re-verified locally against the regex `deepseek[\s\-_]*v4[\s\-_]*pro(?:[\s\-_]*\d{3,4})?` over title + abstract. Only confirmed matches are listed above.
- Queries executed:

  - *variant "Deepseek V4 pro" within active subjects* -> 44 raw records

    ```
    all:"Deepseek V4 pro" AND (cat:cs.AI OR cat:cs.AR OR cat:cs.CG OR cat:cs.CL OR cat:cs.CR OR cat:cs.CV OR cat:cs.DB OR cat:cs.DC OR cat:cs.DS OR cat:cs.ET OR cat:cs.GR OR cat:cs.GT OR cat:cs.HC OR cat:cs.IR OR cat:cs.LG OR cat:cs.MA OR cat:cs.MM OR cat:cs.NE OR cat:cs.PL OR cat:cs.RO OR cat:cs.SE OR cat:cs.SY OR cat:eess.AS OR cat:eess.IV OR cat:eess.SP OR cat:math.OC OR cat:math.ST OR cat:q-bio.NC OR cat:quant-ph OR cat:stat.ML)
    ```
  ...
  - *variant "deepseekv4pro" within active subjects* -> 1 raw records

    ```
    all:"deepseekv4pro" AND (cat:cs.AI OR cat:cs.AR OR cat:cs.CG OR cat:cs.CL OR cat:cs.CR OR cat:cs.CV OR cat:cs.DB OR cat:cs.DC OR cat:cs.DS OR cat:cs.ET OR cat:cs.GR OR cat:cs.GT OR cat:cs.HC OR cat:cs.IR OR cat:cs.LG OR cat:cs.MA OR cat:cs.MM OR cat:cs.NE OR cat:cs.PL OR cat:cs.RO OR cat:cs.SE OR cat:cs.SY OR cat:eess.AS OR cat:eess.IV OR cat:eess.SP OR cat:math.OC OR cat:math.ST OR cat:q-bio.NC OR cat:quant-ph OR cat:stat.ML)
    ```

  - *variant "deepseek-v4-pro-0813" within active subjects* -> 0 raw records

    ```
    all:"deepseek-v4-pro-0813" AND (cat:cs.AI OR cat:cs.AR OR cat:cs.CG OR cat:cs.CL OR cat:cs.CR OR cat:cs.CV OR cat:cs.DB OR cat:cs.DC OR cat:cs.DS OR cat:cs.ET OR cat:cs.GR OR cat:cs.GT OR cat:cs.HC OR cat:cs.IR OR cat:cs.LG OR cat:cs.MA OR cat:cs.MM OR cat:cs.NE OR cat:cs.PL OR cat:cs.RO OR cat:cs.SE OR cat:cs.SY OR cat:eess.AS OR cat:eess.IV OR cat:eess.SP OR cat:math.OC OR cat:math.ST OR cat:q-bio.NC OR cat:quant-ph OR cat:stat.ML)
    ```

  - *variant "Deepseek V4 pro" across all of arXiv (control)* -> 44 raw records
  ...
  - *variant "deepseekv4pro" across all of arXiv (control)* -> 1 raw records

    ```
    all:"deepseekv4pro"
    ```

  - *variant "deepseek-v4-pro-0813" across all of arXiv (control)* -> 0 raw records

    ```
    all:"deepseek-v4-pro-0813"
    ```

  - *supplementary: "deepseek" within active subjects* -> 300 raw records

    ```
    all:"deepseek" AND (cat:cs.AI OR cat:cs.AR OR cat:cs.CG OR cat:cs.CL OR cat:cs.CR OR cat:cs.CV OR cat:cs.DB OR cat:cs.DC OR cat:cs.DS OR cat:cs.ET OR cat:cs.GR OR cat:cs.GT OR cat:cs.HC OR cat:cs.IR OR cat:cs.LG OR cat:cs.MA OR cat:cs.MM OR cat:cs.NE OR cat:cs.PL OR cat:cs.RO OR cat:cs.SE OR cat:cs.SY OR cat:eess.AS OR cat:eess.IV OR cat:eess.SP OR cat:math.OC OR cat:math.ST OR cat:q-bio.NC OR cat:quant-ph OR cat:stat.ML)
    ```

### Active subjects queried

`cs.AI`, `cs.AR`, `cs.CG`, `cs.CL`, `cs.CR`, `cs.CV`, `cs.DB`, `cs.DC`, `cs.DS`, `cs.ET`, `cs.GR`, `cs.GT`, `cs.HC`, `cs.IR`, `cs.LG`, `cs.MA`, `cs.MM`, `cs.NE`, `cs.PL`, `cs.RO`, `cs.SE`, `cs.SY`, `eess.AS`, `eess.IV`, `eess.SP`, `math.OC`, `math.ST`, `q-bio.NC`, `quant-ph`, `stat.ML`

### Companion files

- `deepseek-v4-pro_arxiv_papers.csv` - the 43 confirmed papers as CSV (full abstracts, authors, links).
- `deepseek-v4-pro_arxiv_20260831T110259Z.json` - raw unfiltered API response for all 9 queries, for audit.