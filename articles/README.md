...
| DeepSeek V4 Pro | WordPress | `deepseek-v4-pro/wp-deepseek-v4-pro-sweep.md` | 27 usable posts |

All ten platforms are collected for DeepSeek V4 Pro (TikTok and Instagram
...
relevance and joins each post to the sweep's provenance read; WordPress shows
the >=2-artifact usable set and excludes the 5 injected malware-lure pages). A
model with a platform still to collect shows a "not collected yet" notice for it
